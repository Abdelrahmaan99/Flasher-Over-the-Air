...
void main ( void ){
	...
	status = ESP_u8ReceiveHttpReq((u8*)"GET http://bionist-ota.freevar.com/FOTA_WEB/mc_check.txt\r\n" , (u8*)"58");
	...
	if(status == '1')
	{
		...
		while(1)
		{
			...
			ESP_voidSendOk( (u8 *)"GET http://bionist-ota.freevar.com/FOTA_WEB/Reciver.php?Rx=ok\r\n" , (u8 *)"63" );

			ESP_voidConnectToSrvTcp( (u8 *)"162.253.155.226" , (u8 *)"80" );

			ESP_voidReceiveHttpReq( (u8 *)"GET http://bionist-ota.freevar.com/FOTA_WEB/record.txt\r\n" , (u8 *)"56" , DataCome);
